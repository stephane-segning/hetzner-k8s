...
The nodes themselves should advertise their private Hetzner network IPs to Kubernetes. This is required for Hetzner load
balancers configured with private backend networking.
